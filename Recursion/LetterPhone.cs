...
namespace AlgsDS.Recursion
{
    class LetterPhone
    {
        public static void Run()
        {
            ...
            resultList = letterCombinations("120");//120 - 1a0 1b0 1c0 
            //phone("abc".ToCharArray().ToList(), "def".ToCharArray().ToList(), resultList);
            AlgsDSHelper.DisplayListOfStrings(resultList);
        }
